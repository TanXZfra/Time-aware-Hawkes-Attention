...
from models.utils import RunnerPhase, set_optimizer, set_device
...
class TorchModelWrapper:
    def __init__(self, model, base_config, model_config, trainer_config):
        ...
        if self.model_config.is_training:
            ...
            self.opt = set_optimizer(optimizer, self.model.named_parameters(), self.learning_rate, self.trainer_config)
