...
class TrainerConfig(Config):
    ...
    def __init__(self, **kwargs):
        ...
        self.l2_coef = kwargs.get('l2_coef', 0.1)  # Default value for L2 regularization coefficient
...
class ModelConfig(Config):
    def __init__(self, **kwargs):
        ...
        self.d_k = kwargs.get('d_k', 16)
        self.d_v = kwargs.get('d_v', 16)
        self.phi_width = kwargs.get('phi_width', 8)
        self.phi_depth = kwargs.get('phi_depth', 2)
        self.rnn = kwargs.get('rnn', True)
        self.d_rnn = kwargs.get('d_rnn', 16)
