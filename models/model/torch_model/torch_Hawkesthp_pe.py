...
class HawkesTHP_pe(TorchBaseModel):
    ...
    def __init__(self, model_config):
        ...
        """
        super(HawkesTHP_pe, self).__init__(model_config)
...
class Encoder(nn.Module):
    ...
    def __init__(
            ...
            n_layers, n_head, d_k, d_v,phi_width, phi_depth, dropout, device):
        super().__init__()
    ...
    def forward(self, event_type, event_time, non_pad_mask):
        ...
        time_enc = self.layer_temporal_encoding(event_time)
