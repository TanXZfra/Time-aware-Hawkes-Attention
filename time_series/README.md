...
```bash
python -u run.py --is_training 1 --root_path ./dataset/ETT/ --data_path ETTh1.csv --model_id ETTh1_96_96 --model hawkes --data ETTh1 --features M --seq_len 96 --pred_len 96 --enc_in 7 --dec_in 7 --c_out 7 --des 'Exp' --d_model 8 --d_ff 64 --itr 1 --label_len 0 --num_layers 2 --n_heads 2 --tmlp_width 4 --tmlp_depth 2 --patience 2 --train_epochs 10 --learning_rate 0.001 --batch_size 256
```
