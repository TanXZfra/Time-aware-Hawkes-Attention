import argparse
import torch
from experiments.exp_long_term_forecasting2 import Exp_Long_Term_Forecast2
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tmlp_depth', type=int, default=2,help='time mlp depth')


    args = parser.parse_args()
    args.use_gpu = True if torch.cuda.is_available() and args.use_gpu else False

    freq_map = {'h':4, 't':5, 's':6, 'd':3, 'w':2, 'm':1, 'b':3, 'a':1}
    args.time_dim = freq_map[args.freq]
